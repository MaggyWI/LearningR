...
Function scale_fill_viridis_d() for discrete variables
Function scale_colour_viridis_c() for continuous variables : We use _colour_ instead of _fill_ in the scale_ name because, well, we are using the colour = argument. The _c at the end indicates the variable are continuous.
